...
class PNG:
    ...
    def fourierTransform(self):
        ...
        ax1.axis('off')
        ax2.imshow(f_transform_shifted.real, cmap='gray')
        ax2.set_title('Fourier Spectrum')
        ax2.axis('off')
        ax3.imshow(spectrum_magnitude.real, cmap='gray')
        ax3.set_title('Fourier Spectrum Magnitude')
        ax3.axis('off')
        ax4.imshow(inverse_transform, cmap='gray')
        ax4.set_title('Inverse Transform')
        ax4.axis('off')
